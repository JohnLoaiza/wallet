          ...
          return
            Card(
                child: InkWell(
                  ...
                  child: ListTile(
                    leading: trans[index].nombreCli == 'earning'? Icon(Icons.attach_money): Icon(Icons.perm_identity),
                    title: Text(trans[index].nombreCli),
                    subtitle: Text(trans[index].telefonoCli.toString()),
                  ),
                )
            );
        });
